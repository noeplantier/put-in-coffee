...
export const fallbackSettings: Partial<SiteSettings> = {
  ...
  phone: '+62 819-1633-4989',
  whatsapp: '6281916334989',
...
export const fallbackReviews: Review[] = [
  ...
  },
  {
    ...
    reviewText: 'A true gem on the Denpasar beachfront. The atmosphere is romantic and utterly relaxed — exactly what you dream of when you say "Bali café". We watched the sunset from our table and couldn\'t believe this place even exists.',
  },
  {
