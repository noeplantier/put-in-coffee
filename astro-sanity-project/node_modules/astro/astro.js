#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/noeplantier/.vscode/extensions/wallabyjs.console-ninja-1.0.532/out/buildHook/index.js').default({tool: 'astro', checkSum: '2025d2f6f3b4be8d767214BhtVBEgHXwkADFIDDVcHBFIBU1ZR', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/noeplantier/.vscode/extensions/wallabyjs.console-ninja-1.0.532/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '2025d2f6f3b4be8d767214BhtVBEgHXwkADFIDDVcHBFIBU1ZR', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
